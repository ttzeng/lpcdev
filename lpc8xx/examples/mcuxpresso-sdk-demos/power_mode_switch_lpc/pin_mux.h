...
#define BOARD_DEBUG_UART_TX_PIN 6U                                /*!<@brief 0U pin index: 6 */
#define BOARD_DEBUG_UART_TX_PIN_NAME PIO0_6                       /*!<@brief Pin name */
#define BOARD_DEBUG_UART_TX_LABEL "P2[13]/J2[6]/TARGET_TX-PIO0_6" /*!<@brief Label */
...
#define BOARD_DEBUG_UART_RX_PIN 1U                          /*!<@brief 0U pin index: 1 */
#define BOARD_DEBUG_UART_RX_PIN_NAME PIO0_1                 /*!<@brief Pin name */
#define BOARD_DEBUG_UART_RX_LABEL "U4[13]/TARGET_RX-PIO0_1" /*!<@brief Label */
