...
- pin_list:
  ...
  - {pin_num: '2', peripheral: SCT0, signal: 'OUT, 2', pin_signal: PIO0_13}
  - {pin_num: '3', peripheral: SCT0, signal: 'OUT, 3', pin_signal: PIO0_12}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* SCT_OUT2 connect to P0_13 */
    SWM_SetMovablePinSelect(SWM0, kSWM_CTOUT_2, kSWM_PortPin_P0_13);
